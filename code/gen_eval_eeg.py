...
if __name__ == '__main__':
    ...
    grid, samples = generative_model.generate(dataset_test, config.num_samples,  # Expected size 5 but got size 1 for tensor number 1 in the list
